...
{!! Form::open(['route' => 'gismobile.scansp.store', 'method' => 'post',  'id'=>'form_scpag']) !!}
<div class="content-container">
    ...
    @include('gudang._modal-gudang-tambah')
    ...
    <script>
        ...
        var url = '{{ route("gismobile.scansp.dt") }}'
        ...
        $("#display-btn").on("click", function(){
                var url1 = "{{ route('gismobile.scansp.dt') }}"
        ...
        function hapus(id_gudang){
            var urldel = "{{ route('gismobile.scansp.delete', ['param1']) }}"
        ...
        function inputData(){
            ...
            swal({
                ...
                showLoading()
                $.ajax({
                    url: "{{ route('gismobile.scansp.store') }}",
                    type: 'POST',
