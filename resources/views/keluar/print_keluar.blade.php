                ...
                <table class="table" border="3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td align="center" style="border:1px solid #000; padding: 3px; vertical-align: middle;">{{$row->no_kirim}}</td>
                            <td align="center" style="border:1px solid #000; padding: 3px; vertical-align: middle;">{{$row->tgl_kirim}}</td>
                            ...
                            <td align="center" style="border:1px solid #000; padding: 3px; vertical-align: middle;">{{$row->qty_kirim}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
