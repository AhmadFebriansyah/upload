...
<div class="content-container">
    <div class="box-header with-border">
        <div class="col-lg-2 col-sm-3 col-xs-12 pull-right">
                <a class="btn btn-primary form-control" id="printlp" style="display: block;" href="{{route('gismobile.input_surat')}}"><i class="fa fa-plus custom-icon-info"></i> &nbsp;Tambah Data</a>
            </div>
        </div>
    </div>
</div>   
...
<div class="content-container">
    ...
    <script>
        ...
        var url = '{{ route("gismobile.surat.dt", [base64_encode(\Carbon\Carbon::now()->format("Y-m-d")),\
        ...
        $("#display-btn").on("click", function(){
                ...
                var url1 = "{{ route('gismobile.surat.dt', ['param1','param2' ,'param3']) }}"
        ...
        function print_excel(no_surat) {
            ...
            var url = '{{ route("gismobile.surat.print", ['param1']) }}'
