            ...
            <table style="position: absolute; right:230;">
                <tbody>
                    <tr>
                        ...
                        <td style="float: right;"> {!! date('d F Y', strtotime($master->tgl)) !!} </td>
                    </tr>
    ...
    <div class="col-xs-12">
        <table>
                    <tbody>
                        <tr>
                            <td>
                        <b style="color:#00008B; margin-left:100px">SURAT JALAN NO.</b>  {{$master[0]->no_surat}}
                        </td>
            ...
            <table>
                    <tbody>
                        <tr>
                        <td>
                        <b style="color:#00008B; margin-left:100px">Kami kirim dengan kendaraan</b> {{$master[0]->kendaraan}}
                        </td>
