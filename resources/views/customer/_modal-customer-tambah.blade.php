            ...
            <div class="modal-body">
                ...
                <div id="formscan">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-3">
                            {!! Form::label('lblkode_brg', 'KODE CUSTOMER') !!}
                        </div>
                        <div class="col-sm-9">
                        @if ('#id_customer' !== null)
                           {!! Form::number('id_customer', null, ['class'=>'form-control','placeholder' => 'Kode Customer', 'name' => 'id_customer', 
                    ...
                    <div class="row form-group">
                        <div class="col-sm-3">
                            {!! Form::label('lblnama_barang', 'NAMA CUSTOMER') !!}
                        </div>
                        <div class="col-sm-9">
                            {!! Form::text('nama_customer', null, ['class'=>'form-control','placeholder' => 'Nama Customer', 'name' => 'nama_customer', 
                            'id' => 'nama_customer']) !!}
                        </div>           
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-sm-3">
                            {!! Form::label('lblnama_barang', 'ALAMAT') !!}
                        </div>
                        <div class="col-sm-9">
                            {!! Form::text('alamat_customer', null, ['class'=>'form-control','placeholder' => 'Alamat', 'name' => 'alamat_customer', 
                            'id' => 'alamat_customer']) !!}
                        </div>           
                    </div>
                    ...
                    <div class="row form-group">
                        <div class="col-sm-3">
                            {!! Form::label('lblnama_barang', 'TELPON') !!}
                        </div>
                        <div class="col-sm-9">
                            {!! Form::number('no_telp', null, ['class'=>'form-control','placeholder' => 'Telpon', 'name' => 'no_telp', 
                            'id' => 'no_telp']) !!}
                        </div>           
                    </div>
