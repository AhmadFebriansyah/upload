...
<?php echo Form::open(['route' => 'gismobile.produk.store', 'method' => 'post',  'id'=>'form_scpag']); ?>
...
<div class="content-container">
    ...
    <?php echo $__env->make('produk._modal-produk-tambah', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script>
        ...
        var url = '<?php echo e(route("gismobile.produk.dt")); ?>'
        ...
        $("#display-btn").on("click", function(){
                var url1 = "<?php echo e(route('gismobile.produk.dt')); ?>"
        ...
        function hapus(id_produk){
            var urldel = "<?php echo e(route('gismobile.produk.delete', ['param1'])); ?>"
        ...
        function inputData(){
            ...
            swal({
                ...
                showLoading()
                $.ajax({
                    url: "<?php echo e(route('gismobile.produk.store')); ?>",
                    type: 'POST',
