            ...
            <div class="modal-body">
                ...
                <div id="formscan">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-3">
                            <?php echo Form::label('lblkode_brg', 'KODE GUDANG'); ?>

                        </div>
                        <div class="col-sm-9">
                            <?php echo Form::text('id_gudang', null, ['class'=>'form-control','placeholder' => 'Kode Barang', 'name' => 'id_gudang', 
                            'id' => 'id_gudang']); ?>
                    ...
                    <div class="row form-group">
                        <div class="col-sm-3">
                            <?php echo Form::label('lblnama_barang', 'NAMA GUDANG'); ?>

                        </div>
                        <div class="col-sm-9">
                            <?php echo Form::text('nama_gudang', null, ['class'=>'form-control','placeholder' => 'Nama Barang', 'name' => 'nama_gudang', 
                            'id' => 'nama_gudang']); ?>
