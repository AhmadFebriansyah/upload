...
<html lang="en">
<head>
  <title><?php echo e((!isset($title) ? (!isset($judul) ? "e-Spartan App" : $judul) : $title)); ?></title>
...
<body style="background-color: #eeeeee;">
  ...
  <nav class="navbar navbar-inverse">
    <div class="container-fluid">
      <div class="navbar-header">
        <div class="menu-open"><span class="fa fa-chevron-down"></span> &nbsp;&nbsp; <?php echo e(!isset($judul) ? "e-Spartan App" : $judul); ?></div>
      </div>
      <ul class="nav navbar-nav" style="display:none;">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo e(url('home')); ?>">Portal Karyawan</a></li>
          </ul>
        </li>
      </ul>
  ...
  <?php echo $__env->make('layouts.script2', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  ...
  <script src="<?php echo e(asset('js/jquery.autosize.js')); ?>"></script>
  ...
  <script>
    ...
    <?php if(isset($user)): ?>
    <?php if(strlen($user)>5): ?>
    var html = '<a href="<?php echo e(url('home')); ?>">\
      <div class="menu-sidebar-sub-menu">\
        <img class="menu-sidebar-sub-menu-icon" src="<?php echo e(asset('images/icon_dashboard/umum/dashboard.png')); ?>" alt="">PORTAL SUPPLIER\
      </div>\
    </a>'
    <?php else: ?> 
    var html = '<a href="">\
      <div class="menu-sidebar-sub-menu">\
        <img class="menu-sidebar-sub-menu-icon" src="<?php echo e(asset('images/icon_dashboard/umum/dashboard.png')); ?>" alt="">DASHBOARD E-SPARTAN\
      </div>\
    </a>'
    <?php endif; ?>
