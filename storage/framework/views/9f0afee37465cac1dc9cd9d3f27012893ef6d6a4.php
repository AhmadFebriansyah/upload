...
<?php echo Form::close(); ?>
    ...
    <?php $__env->stopSection(); ?>
    <?php echo $__env->make('masuk._modal-masuk-tambah', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script>
        ...
        var url = '<?php echo e(route("gismobile.masuk.dt", [base64_encode(\Carbon\Carbon::now()->format("Y-m-d")),\
        ...
        $("#display-btn").on("click", function(){
                ...
                var url1 = "<?php echo e(route('gismobile.masuk.dt', ['param1','param2' ,'param3','param4','param5'])); ?>"
        ...
        function hapus(kd_trans){
            var urldel = "<?php echo e(route('gismobile.masuk.delete', ['param1'])); ?>"
    ...
    $("#kd_trans").change(function(){
        ...
        function gen_trans() {
            ...
            url = '<?php echo e(route('gismobile.masuk.gen_trans')); ?>'
            token = window.Laravel.csrfToken
    ...
    $('#sub-btn').on('click', function() {
        ...
        function inputData(){
            swal({
                ...
                showLoading()
                $.ajax({
                    url: "<?php echo e(route('gismobile.masuk.store')); ?>",
                    type: 'POST',
        ...
        function print_excel() {
            ...
            var produk = $('#produk').val();
            var id_customer = $('#id_customer').val();
            var url = '<?php echo e(route("gismobile.masuk.print", ['param1', 'param2', 'param3', 'param4', 'param5'])); ?>'
        ...
        function print_pdf(kd_trans) {
            console.log(kd_trans);
            var url = '<?php echo e(route("gismobile.masuk.pdf", ['param1'])); ?>'
