...
<?php echo Form::open(['route' => 'gismobile.customer.store', 'method' => 'post',  'id'=>'form_scpag']); ?>
...
<div class="content-container">
    ...
    <?php echo $__env->make('customer._modal-customer-tambah', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <script>
        ...
        var url = '<?php echo e(route("gismobile.customer.dt")); ?>'
        ...
        $("#display-btn").on("click", function(){
                var url1 = "<?php echo e(route('gismobile.customer.dt')); ?>"
        ...
        function hapus(id_customer){
            var urldel = "<?php echo e(route('gismobile.customer.delete', ['param1'])); ?>"
        ...
        function inputData(){
            ...
            swal({
                ...
                showLoading()
                $.ajax({
                    url: "<?php echo e(route('gismobile.customer.store')); ?>",
                    type: 'POST',
